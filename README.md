...
* Quando un cliente effettua un **ordine**, ogni prodotto selezionato (**riga ordine**) viene salvato temporaneamente nel **carrello** come **righe carrello** fino alla conferma o alla cancellazione (di fatto, il carrello rappresenta l'ordine *aperto*, dunque l'ordine riporta solo la data di creazione, che equivale alla data di chiusura delle specifiche originali).
